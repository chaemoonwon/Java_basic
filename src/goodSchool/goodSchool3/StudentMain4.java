...
////                };
//
//        ScoreBox<ScorePolicy> scoreBox = new ScoreBox<>();
//
//        //제네릭 타입은 다형성 원리가 적용 가능
////        scoreBox.add(new RequireScore());
////        scoreBox.add(new GenerateScore());
//
//
//        //국어 수강생 학점 출력
//        KorStudentScore(students, subject, scoreBox.add(new RequireScore().getGrade()), scoreBox.add(new GenerateScore()));
//
//        //수학 수강생 학점 출력
...
//    }
//
//    private static void KorStudentScore(Student[] students, Subject subject, ScoreBox<RequireScore> requireScore, ScorePolicy generateScore) {
//        System.out.println("국어 수강생 학점");
//        System.out.println("이름  |   학번  |중점과목|  점수");
//        for (Student student : students) {
//            if (student.major.equals(Major.KOREAN)) {
//                System.out.println(student.stName + " | " + student.stNum + " | " + subject.getSubject(Major.KOREAN) + " | " + student.kor + " | " + requireScore.(student.kor));
